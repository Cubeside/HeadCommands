...
public class HeadCommandsConfig {
    ...
    public HeadCommandsConfig(SQLConfig sqlConfig, URI apiBaseUri, String apiKey, boolean refreshOnEnable, int resultsPerPage, int connectTimeoutSeconds, int requestTimeoutSeconds) {
